...
<jsp:include page="admin_header.jsp">
    ...
    <jsp:param name="goodsmanage" value="2"></jsp:param>
</jsp:include>
<div class="container">
    <form action="${pageContext.request.contextPath}/goods_editServlet" method="post">
        <div class="edit">
            ...
            <div>介绍<input type="text" name="introduce" ></div>
            <div>库存<input type="text" name="stock"></div>
            <div>销量<input type="text" name="sell" ></div>
            <div>发布日期<input type="date" name="date"></div>
            <div>图片<%--        文件夹的导入--%><input type="file" name="image"  id="input_file" ></div>
